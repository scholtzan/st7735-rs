...
fn main() {
    ...
    display.draw_character('!', 80, 85, &Color::from_default(DefaultColor::White), Font57 {});
    display.draw_character('i', 85, 85, &Color::from_default(DefaultColor::White), Font57 {});
    display.draw_character('H', 90, 85, &Color::from_default(DefaultColor::White), Font57 {});
